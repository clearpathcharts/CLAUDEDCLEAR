...
export const FacebookIntel: React.FC = React.memo(() => {
  ...
  // Multiple mini-avatars to represent the active "Sovereign Market Traders" community
  const avatars = [
  ...
  return (
    <div className="flex flex-col h-full justify-between font-sans text-neutral-200">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-white/5">
        <div className="flex items-center gap-2.5">
          ...
          <div className="space-y-0.5">
            <h4 className="text-[11px] font-black tracking-wider uppercase text-white font-serif">
        ...
        {/* Action icons */}
        <button type="button" aria-label="More options" className="text-zinc-500 hover:text-white transition-colors cursor-pointer">
      ...
      {/* 3. Social Engagement & Actions Row */}
      <div className="space-y-3 pt-1">
        ...
        <div className="grid grid-cols-3 gap-2 pt-2 border-t border-white/5">
          ...
          <button
            type="button"
            className="py-1.5 rounded-xl border border-white/5 bg-[#030307]/40 hover:border-zinc-800 text-zinc-400 hover:text-white flex items-center justify-center gap-1.5 font-mono text-[9px] uppercase font-black transition-all"
          >
            <Share2 size={11} />
            <span>Share</span>
          </button>
