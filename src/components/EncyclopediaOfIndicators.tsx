                ...
                {filteredIndicators.map(p => {
                  ...
                  return (
                    <article 
                      ...
                      `}
                    >
                      <div className="h-[140px] bg-[#071226] relative overflow-hidden shrink-0 group border-b border-[#00B6FF]/30">
                         <IndicatorThumbnail name={p.name} visualType={p.visualType} className="w-full h-full object-cover opacity-90" />
                         <div className="absolute inset-0 bg-gradient-to-t from-[#071226]/80 via-transparent to-transparent pointer-events-none" />
            ...
            <aside className="border border-[#00B6FF]/30 rounded-2xl bg-gradient-to-b from-[#071226]/95 to-[#0A1C3A]/95 shadow-[0_15px_40px_rgba(0,182,255,0.2)] overflow-hidden lg:sticky lg:top-[92px] hidden xl:flex flex-col min-h-[600px] max-h-[85vh] backdrop-blur-xl">
              <div className="flex flex-col h-full animate-in fade-in slide-in-from-right-4 duration-300">
                {selectedIndicator.hasVideo && selectedIndicator.videoUrl ? (
                  ...
                  <div className="w-full h-[200px] bg-[#071226] relative border-b border-[#00B6FF]/30 shrink-0 overflow-hidden">
                     <IndicatorThumbnail name={selectedIndicator.name} visualType={selectedIndicator.visualType} className="w-full h-full" />
                     <div className="absolute inset-0 bg-gradient-to-t from-[#071226] via-[#071226]/20 to-transparent pointer-events-none" />
                  </div>
                )}
