  ...
  return (
    <div className="w-full text-white font-sans min-h-[90vh] relative" id="super_comb_homepage_root">
      <div className="max-w-[1100px] mx-auto space-y-5">
        ...
        {/* Hero */}
        <div className="bg-white/[0.03] border border-white/10 rounded-[20px] p-7 backdrop-blur-md">
        ...
        <button
          ...
          className="w-full bg-white/[0.03] hover:bg-white/[0.06] border border-white/10 rounded-[20px] p-5 flex items-center justify-between transition-all cursor-pointer text-left"
        >
          <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <button
            ...
            className="bg-white/[0.03] hover:bg-white/[0.06] border border-white/10 rounded-[20px] p-5 text-left transition-all cursor-pointer"
          >
        ...
        <button
          ...
          className="w-full bg-white/[0.03] hover:bg-white/[0.06] border border-white/10 rounded-[20px] p-5 flex items-center gap-3.5 transition-all cursor-pointer text-left"
        >
        ...
        <div>
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-[20px] p-5 grid grid-cols-1 md:grid-cols-3 gap-5">
