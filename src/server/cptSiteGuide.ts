...
C.P.T. Buddy: pink floating avatar, bottom-right, on the website, trader desks, and Apple/Android app (Safari, Chrome, installed PWA, APK). Tap it anytime. On phones the chat is a sheet that sits above the keyboard (home indicator / nav bar safe). Or use the "Ask C.P.T." tile on Home.
