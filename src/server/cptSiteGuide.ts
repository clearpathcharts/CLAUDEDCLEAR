...
Explain Mode: a control labeled "Need extra understanding" sits in the top nav (it reads "Explain on" when active). When it is on, a small play-badge appears next to each tab, including EXIT. Tapping the badge opens a cinema-style overlay (16:9 stage for a 30–45 second Google Flow film, plain-language text, shot-by-shot script, short quiz). Produce each film as four ~8–10s Flow shots and stitch them. Drop the finished MP4 at public/explain-videos/{id}.mp4. Missing clips show the storyboard frame, not a fake video. This is extra explanation, not trading advice.
