...
export const REGIONAL_MARKETS: RegionalMarket[] = [
  {
    ...
    cta: {
      ...
      waitlistTitle: 'Private Login — ваш доступ',
      waitlistBody:
        'Листа ожидания нет. Создайте аккаунт с email и паролем на терминале. Почта хранится в Firestore и переживает перезапуски Cloud Run.',
      firstNameLabel: 'Имя',
      emailLabel: 'Email',
      countryLabel: 'Страна',
      countryPlaceholder: 'Россия',
      experienceLabel: 'Опыт',
      submitLabel: 'Открыть Private Login',
      submittingMsg: 'Отправка…',
      successMsg: 'Откройте Private Login на терминале.',
    },
    bodyHtml: `
<article lang="ru">
...
<p><a href="/">Открыть терминал</a> · <a href="/learn">Learn (EN)</a> · <a href="/regions">Все регионы</a></p>
  ...
  },
  {
    ...
    cta: {
      ...
      launchLabel: '启动终端',
      educationLabel: '开始学习',
      waitlistTitle: 'Private Login 才是真正入口',
      waitlistBody:
        '没有候补名单。在终端用邮箱和密码创建账户。该邮箱保存在 Firestore，Cloud Run 重启后仍然有效。',
      firstNameLabel: '名字',
      emailLabel: '邮箱',
      countryLabel: '国家/地区',
      countryPlaceholder: '中国',
      experienceLabel: '经验',
      submitLabel: '打开 Private Login',
      submittingMsg: '提交中…',
      successMsg: '请在终端打开 Private Login。',
    },
    bodyHtml: `
<article lang="zh-CN">
...
<p><a href="/">启动终端</a> · <a href="/regions">全部地区</a> · <a href="/ui">无障碍 / 神经多样性界面</a></p>
  ...
  },
  {
    ...
    cta: {
      ...
      waitlistTitle: 'Private Login が本番の入口',
      waitlistBody:
        '待機リストはありません。ターミナルでメールとパスワードのアカウントを作成してください。Firestore に保存され、Cloud Run 再起動後も残ります。',
      firstNameLabel: '名前',
      emailLabel: 'メール',
      countryLabel: '国',
      countryPlaceholder: '日本',
      experienceLabel: '経験',
      submitLabel: 'Private Login を開く',
      submittingMsg: '送信中…',
      successMsg: 'ターミナルで Private Login を開いてください。',
    },
    bodyHtml: `
<article lang="ja">
...
<p><a href="/">ターミナルを開く</a> · <a href="/regions">地域一覧</a> · <a href="/ui">UIモード</a></p>
  ...
  },
  {
    ...
    cta: {
      ...
      waitlistTitle: 'Private Login ang totoong access',
      waitlistBody:
        'Walang waitlist. Gumawa ng account sa email + password sa terminal. Nakatira iyon sa Firestore at nabubuhay sa Cloud Run restart.',
      firstNameLabel: 'Pangalan',
      emailLabel: 'Email',
      countryLabel: 'Bansa',
      countryPlaceholder: 'Pilipinas',
      experienceLabel: 'Karanasan',
      submitLabel: 'Buksan ang Private Login',
      submittingMsg: 'Isinusumite…',
      successMsg: 'Buksan ang Private Login sa terminal.',
    },
    bodyHtml: `
<article lang="fil">
